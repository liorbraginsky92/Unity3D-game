...
public class UImanager : MonoBehaviour {
   ...
   // public GameObject Evensystem;
    ...
    public IEnumerator delayforAgain()
    {
        ...
        if (alowshowads %2 ==0)
        {
            _btnunityAds.transform.GetChild(1).gameObject.SetActive(UnityAds.instance.UnityAdsloaded());
            _btnunityAds.transform.GetChild(2).gameObject.SetActive(!UnityAds.instance.UnityAdsloaded());
        }
        else
        {
            _btnunityAds.transform.GetChild(1).gameObject.SetActive(!UnityAds.instance.UnityAdsloaded());
